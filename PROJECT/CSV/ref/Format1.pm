...
sub Write_DBI {
  ...
  foreach my $aa (@ddl) {
 	...
 	my $sql = "INSERT INTO $table_name (Empid,Name,Age,Salary,Qualification,Exp)
         VALUES(?,?,?,?,?,?)";
